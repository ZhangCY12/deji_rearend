...
public class CNCsController {
    ...
    @Autowired
    private SingelEnergyService singelEnergyService;
    ...
    @GetMapping("/singleEnergy")
    public Result GetSingleEnergy(){
        return  Result.ok().data("energy",singelEnergyService.selectAllSingleEnergy());
    }
}
